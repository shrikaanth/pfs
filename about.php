...
<body>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <div class="about-hero-content fade-in-up">
                        <h1 class="font-playfair hero-title">About Photo Factory Studio</h1>
                        <p class="hero-subtitle">Discover the passion, artistry, and dedication behind every frame we capture</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 fade-in-left">
                    <div class="story-content">
                        ...
                        <div class="story-highlight">
                            <p>"We don't just take photographs; we create visual poetry that tells your story for generations to come."</p>
                        </div>
                        <p class="story-text">
    ...
    <section class="values-section">
        <div class="container">
            <div class="values-title fade-in-up">
                <h2 class="font-playfair">Our Values</h2>
                <p>The principles that guide every decision we make and every photograph we create</p>
            </div>
            <div class="row">
    ...
    <section class="usp-section">
        <div class="container">
            <div class="usp-title fade-in-up">
                <h2 class="font-playfair">Why Choose Us</h2>
                <p>Discover what sets Photo Factory Studio apart in the world of professional photography</p>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.1s;">
                    <div class="usp-card">
                        <div class="usp-number">01</div>
                        <h3 class="usp-card-title">Award-Winning Team</h3>
                ...
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.2s;">
                    <div class="usp-card">
                        ...
                        <h3 class="usp-card-title">Cutting-Edge Equipment</h3>
                        <p class="usp-description">
                ...
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.3s;">
                    <div class="usp-card">
                        ...
                        <h3 class="usp-card-title">Personalized Approach</h3>
                        <p class="usp-description">
                ...
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.4s;">
                    <div class="usp-card">
                        ...
                        <h3 class="usp-card-title">Quick Turnaround</h3>
                        <p class="usp-description">
                ...
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.5s;">
                    <div class="usp-card">
                        ...
                        <h3 class="usp-card-title">Comprehensive Packages</h3>
                        <p class="usp-description">
                ...
                <div class="col-lg-4 col-md-6 mb-4 fade-in-up" style="transition-delay: 0.6s;">
                    <div class="usp-card">
                        ...
                        <h3 class="usp-card-title">Lifetime Support</h3>
                        <p class="usp-description">
